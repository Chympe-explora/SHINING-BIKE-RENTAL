...
(function () {
  ...
  // ============================================================
    ...
    window.KC_CONTENT = {
      ...
      // ---- 🏍️ "Rent a Bike or Scooter" — home page section, right after
      // Meet Your Guide. Each vehicle needs an "id" (must match a key in
      // window.KC_PRICES.vehicleRental.vehicles above), a "name", a
      // "type" (shown in the rental form's vehicle dropdown), a short
      // one-line "description", and an optional "badge" tag. Turn the
      // whole section off via sections.vehicleRental above.
      vehicleRental: {
      ...
      // Now" form before a visitor can submit. Same shape as
      // refundPolicy.sections below: each has a "number", a "heading",
      // and "blocks" (either { text } for a paragraph or { type: "list",
      // lead, items } for a bullet list).
      rentalPolicy: {
        sections: [
          {
            number: 1,
            ...
            blocks: [
              { type: "list", items: [
                "The renter must be at least 18 years old and hold a valid driving license.",
                "Original license and ID proof must be presented at the time of pickup.",
                "The rental is strictly for use within the state of Meghalaya."
              ] }
            ]
          },
          {
            ...
            heading: "Fuel Policy",
            blocks: [
              { text: "The vehicle is provided with a full tank of fuel and must be returned with a full tank. If returned empty, the renter will be charged for the full refill cost." }
            ]
          },
          {
            number: 3,
            heading: "Late Return & Extensions",
            blocks: [
              { type: "list", items: [
                "6-Hour Plan: no hourly extensions — a late return automatically converts to the 12-hour rate.",
                "12-Hour Plan: must be returned by 8:00 PM, or it converts to the full 24-hour rate.",
                "24-Hour Plan: notify us at least 3 hours before the scheduled return time for an extension; no hourly extensions after 8:00 PM.",
                "Late fee: ₹70 per hour for delays up to 2 hours. Delays beyond 2 hours are charged as a full extra 24-hour rental."
              ] }
            ]
          },
          {
            ...
            blocks: [
              { type: "list", items: [
                "Strictly prohibited: racing, off-road riding, unlawful activities, sub-renting to third parties, or carrying more than two people.",
                "A 360° video of the vehicle's condition must be recorded before taking possession, to avoid disputes.",
                "A ₹100 washing fee applies if the vehicle is returned dirty or muddy."
              ] }
            ]
          },
          {
            ...
            blocks: [
              ...
              { type: "list", items: [
                ...
                "Full payment is due for any lost or damaged helmets or raincoats.",
                "Mechanical issues must be reported immediately — unreported issues become the renter's responsibility."
              ] }
            ]
          },
          {
            ...
            blocks: [
              { type: "list", items: [
                "30% refundable if cancelled 12–24 hours before the booking; no refund inside 12 hours.",
                "No refunds (full or partial) for early returns once the rental has started.",
                "We reserve the right to cancel any booking or refuse an extension at our discretion."
              ] }
            ]
          }
        ]
